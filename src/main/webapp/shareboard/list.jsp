...
<div id="container">
	...
	<%
		...
		try{
			String sql ="select s_num,m_id,s_subject,s_writedate,s_readnum from shareboard order by s_num desc";
	...
	<% 
			...
			while(rs.next()){
				...
				if(s_subject.length() >= 20){
					s_subject = s_subject.substring(0,20) + "..."; 
				}
