...
<head>
<meta charset="UTF-8">
<title>공유게시판 작성</title>
<link rel="stylesheet" href="../boardStyle.css">
</head>
<body onload="document.shareboard.r_id.focus();">
<div id="container">
		<header>
			<div id="topheader">
				<div id="loginbox">
		...
		<div id="contents">
			...
			* 게시판 수정과 삭제를 위하여 반드시 비밀번호를 입력하세요.
			<form action="write_ok.jsp" method="post" name="shareboard">
			<input type="hidden" name="m_num" value="">
				<table border="1" width="600">
					...
					<tr>
						<td>제목</td>
						<td><input type="text" name="s_subject"></td>
					</tr>
					<tr>
						<td>내용</td>
						<td><textarea name="s_content" rows="5" cols="50"></textarea></td>
					</tr>
					<tr>
						<td colspan="2">
