...
<div id="container">
	...
	<%
		...
		try{
			String sql = "select m_id,s_subject,s_content from shareboard where s_num=?";
	...
	%>
	<h3>게시물 수정</h3>
	<form action="edit_ok.jsp" method="post" name="shareboard">
		...
		<table border="1" width="600">
			...
			<tr>
				<td>제목</td>
				<td><input type="text" name="s_subject" value="<%=s_subject%>"></td>
			</tr>
			<tr>
				<td>내용</td>
				<td><textarea name="s_content" rows="5" cols="50"><%=s_content %></textarea></td>
			</tr>
			<tr>
				<td colspan="2">
