...
<body>
	<div id="container">
		...
		<div id="contents">
			Book of Us는 정보통신망법 제50조의 2, 제50조의 7 등에 의거하여, 운영·관리하는 웹페이지 상에 게시된 이메일 주소가 전자우편
			<br>수집 프로그램이나 그 밖의 기술적 장치를 이용하여 무단으로 수집되는 것을 거부합니다. 이를 위반시 정보통신망법에 의해 형사처벌됨을 유념하시기 바랍니다.
		</div>
		<footer>    
	      <div id="bottomMenu">
	        <ul>
