...
<body>
	...
	<div id="container">
		...
		<div id="contents">
			<h3>좋은 독서습관</h3>
			<ol>
				<li> 어릴 때부터 책 읽는 습관을 기릅니다.</li>
				<li> 매일 조금씩 읽습니다.</li>
				<li> 내용을 이해하면서 읽습니다.	</li>
				<li> 주의를 정돈하여 조용하고 침착한 분위기 속에서 읽도록 합니다.</li>
				<li> 여러 가지 책을 고루 읽습니다.</li>
				<li> 읽고 나서 기록하는 습관을 기릅니다.</li>
				<li> 자기가 선택한 책은 끝까지 읽습니다.</li>
				<li> 읽은 것은 서로 이야기를 해보면 두 번 읽는 효과를 보게 됩니다.</li>
				<li> 독서 위생을 꼭 지켜야 합니다.</li>
			</ol>
