...
<div id="container">
	...
	<%
		...
		try{
			String sql = "select n_num, m_id, n_subject, n_content, n_writedate, n_readnum from notice where n_num=?";
	...
	%>
		<table border="1" width="600">
			...
			<tr>
				<td>제목</td>
				<td colspan="3"><%=n_subject %></td>
			</tr>
			<tr>
				<td colspan="4" style="white-space:pre-Line"><%=n_content %></td>
			</tr>
		</table>
		<%
			m_id = "";
			if(session.getAttribute("m_id")!= null){
				...
				if(m_id.equals("admin")){
		%>	
				<a href="edit.jsp?n_num=<%=n_num%>">수정</a>
				<a href="delete.jsp?n_num=<%=n_num%>">삭제</a>
