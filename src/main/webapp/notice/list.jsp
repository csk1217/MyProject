...
<div id="container">
	...
	<%
		...
		try{
			String sql ="select n_num,m_id,n_subject,n_writedate,n_readnum from notice order by n_num desc";
	...
	<% 
			...
			while(rs.next()){
				...
				if(n_subject.length() >= 20){
					n_subject = n_subject.substring(0,20) + "..."; 
				}
