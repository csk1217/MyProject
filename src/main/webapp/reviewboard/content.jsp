...
<body>
	<div id="container">
		...
		<%
			...
			try{
				String sql = "select r_num, m_id, r_subject, r_content, r_writedate, r_readnum from reviewboard where r_num=?";
		...
		%>
			<table border="1" width="600">
				...
				<tr>
					<td>제목</td>
					<td colspan="3"><%=r_subject %></td>
				</tr>
				<tr>
					<td colspan="4" style="white-space:pre-Line"><%=r_content %></td>
				</tr>
			</table>
			<a href="edit.jsp?r_num=<%=r_num%>">수정</a>
			<a href="delete.jsp?r_num=<%=r_num%>">삭제</a>
