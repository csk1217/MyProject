...
<body>
	...
	<%
		...
		try{
			String sql ="select r_num,m_id,r_subject,r_writedate,r_readnum from reviewboard order by r_num desc";
	...
	<% 
			...
			while(rs.next()){
				...
				if(r_subject.length() >= 20){
					r_subject = r_subject.substring(0,20) + "..."; 
				}
